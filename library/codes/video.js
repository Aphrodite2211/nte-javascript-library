function Video(info){
    ...
    this.modelPosition = info.modelInfo.position?info.modelInfo.position:{x:0,y:0,z:0};
    this.modelRotation = info.modelInfo.rotation?info.modelInfo.rotation:{x:0,y:0,z:0};
